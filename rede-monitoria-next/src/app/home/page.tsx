            ...
            <header className="bg-[#166534] text-white">
                <div className="w-full px-6 py-2.5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <img src="/Logo_RDM.png" className="w-9 h-9 rounded" alt="Rede de Monitoria" />
            ...
            <main className="flex-1">
                <section className="bg-gradient-to-br from-green-800 to-green-600 text-white py-24 px-6">
                    <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
                        <img src="/Logo_RDM.png" className="w-28 h-28 rounded-xl bg-white p-3 shadow-lg mb-8" alt="Logo Rede de Monitoria" />
